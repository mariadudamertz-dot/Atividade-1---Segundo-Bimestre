...
5 - a) Ao executar o código, as mensagens "123" apareceu em cima, pulou linha e apareceu "300" na linha de baixo, pulou mais uma vez e apareceu "100+200" no console do editor;

    b) Na linha seis, o que aconteceu foi que houve uma somatória entre o cem e o 200, pois não havia as aspas para transformar os números em uma frase. Na linha sete, nós utilizamos as aspas, logo, o Portugol entendeu que era uma frase a ser dita e não somado;

6 - Aconteceu que a variável idade estava como valor vinte e um e o código dizia que se idade for maior ou igual a dezoito era pra ser dito "maior de idade".
